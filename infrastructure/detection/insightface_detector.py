...
from core.interfaces.face_detector import FaceDetector
from core.exceptions.face_detection_error import FaceDetectionError
from domain.face import Face, BoundingBox, Landmarks
